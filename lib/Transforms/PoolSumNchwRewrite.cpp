...
LogicalResult PoolSumNchwSparsityScfRewritePattern::matchAndRewrite(
    linalg::PoolingNchwSumOp op, PatternRewriter &rewriter) const {
        ...
        [&](OpBuilder &b, Location loc, Value kh, ValueRange khArgs) {
          ...
          auto kwLoop = scf::ForOp::create(
              ...
              [&](OpBuilder &b, Location loc, Value kw, ValueRange kwArgs) {
                ...
                auto acc = arith::AddFOp::create(b, loc, Onchw, Inchw);
