...
// CHECK-LABEL: func.func @conv2d_nhwc_hwcf_backward_sparsity
func.func @conv2d_nhwc_hwcf_backward_sparsity(
    // CHECK: {proteus.lattice = [{size = 1 : i64, words = array<i64: 1>}, {size = 4 : i64, words = array<i64: 3>}, {size = 4 : i64, words = array<i64: 3>}, {size = 1 : i64, words = array<i64: 1>}]}
    %input : tensor<1x4x4x1xf32>,
    // CHECK: {proteus.lattice = [{size = 2 : i64, words = array<i64: 3>}, {size = 2 : i64, words = array<i64: 3>}, {size = 1 : i64, words = array<i64: 1>}, {size = 1 : i64, words = array<i64: 1>}]}
    %filter : tensor<2x2x1x1xf32>,
    %init : tensor<1x3x3x1xf32>
) -> tensor<1x3x3x1xf32> {
  // CHECK: linalg.conv_2d_nhwc_hwcf {proteus.lattice = [{size = 1 : i64, words = array<i64: 1>}, {size = 3 : i64, words = array<i64: 3>}, {size = 3 : i64, words = array<i64: 3>}, {size = 1 : i64, words = array<i64: 1>}]}
  %0 = linalg.conv_2d_nhwc_hwcf {proteus.lattice = [{size = 1 : i64, words = array<i64: 1>}, {size = 3 : i64, words = array<i64: 3>}, {size = 3 : i64, words = array<i64: 3>}, {size = 1 : i64, words = array<i64: 1>}]} ins(%input, %filter : tensor<1x4x4x1xf32>, tensor<2x2x1x1xf32>) outs(%init : tensor<1x3x3x1xf32>) -> tensor<1x3x3x1xf32>
