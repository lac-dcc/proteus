...
func.func @depthwise_conv2d_nchw_chw_filter_channel_sparsity(
    ...
    %init   : tensor<1x3x2x2xf32> {proteus.lattice = [{size = 1 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}]}
) -> tensor<1x3x2x2xf32> {
