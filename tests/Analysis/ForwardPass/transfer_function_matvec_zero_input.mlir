...
// CHECK-LABEL: func.func @matvec_zero_matrix_rows_test
func.func @matvec_zero_matrix_rows_test(
    %matrix : tensor<4x3xf32> {proteus.lattice = [{size = 4 : i64, words = array<i64: 0>},
  ...
  // CHECK: linalg.matvec {proteus.lattice = [{size = 4 : i64, words = array<i64: 0>}]}
  %0 = linalg.matvec ins(%matrix, %vec : tensor<4x3xf32>, tensor<3xf32>) outs(%init : tensor<4xf32>) -> tensor<4xf32>
  return %0 : tensor<4xf32>
}

// CHECK-LABEL: func.func @matvec_zero_vector_test
func.func @matvec_zero_vector_test(
