...
// CHECK-LABEL: func.func @pad_2d_both_dims_nonzero_fill
func.func @pad_2d_both_dims_nonzero_fill(
    %src  : tensor<3x3xf32> {proteus.lattice = [{size = 3 : i64, words = array<i64: 5>}, {size = 3 : i64, words = array<i64: 6>}]},
    %init : tensor<5x5xf32>
) -> tensor<5x5xf32> {
  %cst = arith.constant 1.0 : f32
  // CHECK: } {proteus.lattice = [{size = 5 : i64, words = array<i64: 31>}, {size = 5 : i64, words = array<i64: 31>}]}
  %0 = tensor.pad %src low[1, 1] high[1, 1] {
  ^bb0(%i: index, %j: index):
    tensor.yield %cst : f32
