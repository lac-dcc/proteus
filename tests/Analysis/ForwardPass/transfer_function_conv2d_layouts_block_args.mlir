...
func.func @conv2d_filter_sparsity(
    ...
    %init_nchw   : tensor<1x3x2x2xf32> {proteus.lattice = [{size = 1 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}]},
    ...
    %init_nhwc   : tensor<1x2x2x3xf32> {proteus.lattice = [{size = 1 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}, {size = 2 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}]}
) -> tensor<1x2x2x3xf32> {
...
func.func @conv2d_h_sparsity(
    ...
    %init_nchw   : tensor<1x1x3x3xf32> {proteus.lattice = [{size = 1 : i64, words = array<i64: 0>}, {size = 1 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}]},
    ...
    %init_nhwc   : tensor<1x3x3x1xf32> {proteus.lattice = [{size = 1 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}, {size = 3 : i64, words = array<i64: 0>}, {size = 1 : i64, words = array<i64: 0>}]}
) -> tensor<1x3x3x1xf32> {
